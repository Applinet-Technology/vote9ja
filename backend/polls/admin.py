...
from .models import Poll, FGPoll, StatePoll, Senatorial_districtPoll,Federal_ConstituentPoll, LGAPoll, WardPoll, FGVote, StateVote, Senatorial_districtVote, Federal_ConstituentVote, LGAVote, WardVote, Result, State_ConstituentPoll, State_ConstituentVote
...
admin.site.register(State_ConstituentPoll)
...
admin.site.register(State_ConstituentVote)
