...
class Poll(models.Model):
    ...
    def poll_is_active(self):
        ...
        if current>expiry:
            return f'{self.manifestoe} Poll with expiry date {expiry} has expired' 
        return f'{self.manifestoe} Poll with expiry date {expiry} is active'
...
class Federal_ConstituentPoll(models.Model):
    ...
    def __str__(self):
        return f'{self.federal_constituency}'
